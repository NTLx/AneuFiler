...
Current release is [`v0.3.0`](https://github.com/NTLx/AneuFiler/releases/tag/v0.3.1), `Pre-release` was not recommended for actual production.
...
[Download Portable for win](https://github.com/NTLx/AneuFiler/releases/download/v0.3.1/AneuFiler.v0.3.1.Win_Portable.exe)
