...
当前发布版本为 [`v0.1.4`](https://github.com/NTLx/AneuFiler/releases/tag/v0.1.4) ， `Pre-release` 版本的核心算法尚未完善，不建议用于实际生产。
...
[Portable 下载链接](https://github.com/NTLx/AneuFiler/releases/download/v0.1.4/AneuFiler.v0.1.4.Win_Portable.exe)

若以上连接效果不佳，请尝试使用 [下载镜像](https://gitee.com/lx3325360/AneuFiler/releases/v0.1.4)
...
[Mac OS 下载链接](https://github.com/NTLx/AneuFiler/releases/download/v0.1.4/AneuFiler.v0.1.4.MacOS.dmg)
